...
import { getDeliveryStatusById } from 'apiSdk/delivery-statuses';
import { DeliveryStatusInterface } from 'interfaces/delivery-status';

function DeliveryStatusViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('delivery_status', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/delivery-statuses/edit/${id}`} passHref legacyBehavior>
                    <Button
