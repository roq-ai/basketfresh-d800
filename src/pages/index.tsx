...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`basketfresh`}</title>

        <meta
          name="description"
          content="Welcome to basketfresh, your trusted ecommerce application for buying fresh meat, fish, and poultry. Quality products at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZWF0fGVufDB8fHx8MTY5Njg3NDIwMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@joseignaciopompe?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`José Ignacio Pompé`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to basketfresh, your trusted ecommerce application for buying fresh meat, fish, and poultry. Quality products at your fingertips.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Customer" type="customer" abilities={appConfig.ownerAbilities} />
